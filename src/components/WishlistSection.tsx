    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 font-sans">
        ...
        <div className="lg:col-span-5">
          <div className="apple-card rounded-2xl sm:rounded-[22px] p-6 sticky top-20">
            <div className="flex items-center gap-2.5 mb-5 pb-3 border-b border-black/[0.04]">
              <div className="p-2 rounded-xl bg-black/[0.04] text-[#1D1D1F]">
              ...
              <div>
                ...
                <p className="text-xs text-[#86868B]">提交至学术智库收录评估</p>
              </div>
            </div>

            {formSuccess && (
              <div className="mb-4 p-3.5 rounded-xl bg-emerald-50 border border-emerald-200/60 text-xs text-emerald-800 flex items-center gap-2">
            ...
            {formError && (
              <div className="mb-4 p-3 rounded-xl bg-rose-50 border border-rose-200/60 text-xs text-rose-800 flex items-center gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs sm:text-sm">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 rounded-xl border border-black/[0.08] bg-[#F5F5F7] text-[#1D1D1F] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0071E3]/20 focus:border-[#0071E3] transition-colors font-sans text-xs"
                >
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-full font-semibold text-xs bg-[#0071E3] hover:bg-[#0077ED] disabled:opacity-40 text-white transition-all shadow-xs flex items-center justify-center gap-2 cursor-pointer"
              >
                {isSubmitting ? (
                  <>
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="apple-card rounded-2xl sm:rounded-[22px] p-6 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-3 border-b border-black/[0.04]">
              <div>
                <h3 className="font-editorial-heading font-bold text-base text-[#1D1D1F]">
                  心愿单收录追踪队列
                </h3>
                <p className="text-xs text-[#86868B]">汇聚学者关注度最高的研究领域与学术期刊</p>
              </div>
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <div className="relative w-full sm:w-48">
                  ...
                  <input
                    ...
                    placeholder="搜索心愿..."
                    className="w-full pl-8 pr-3 py-1.5 text-xs bg-[#F5F5F7] border border-black/[0.06] rounded-full text-[#1D1D1F] focus:outline-none focus:ring-2 focus:ring-[#0071E3]/20 focus:border-[#0071E3] focus:bg-white transition-all"
                  />
                </div>
                {onRefreshWishlist && (
                  <button
                    ...
                    disabled={isLoading}
                    className="p-1.5 rounded-full border border-black/[0.06] bg-[#F5F5F7] text-[#6E6E73] hover:text-[#1D1D1F] hover:bg-black/[0.06] transition-colors cursor-pointer disabled:opacity-50"
                    title="刷新心愿单队列"
                  >
                    <RefreshCw className={`w-3.5 h-3.5 ${isLoading ? 'animate-spin text-[#0071E3]' : ''}`} />
                  </button>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto pb-1 text-xs">
              <span className="text-[#86868B] font-semibold text-[11px] whitespace-nowrap flex items-center gap-1 mr-1">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-xs font-medium transition-colors whitespace-nowrap cursor-pointer ${
                      tableFilter === st.id
                        ...
                        : 'bg-[#F5F5F7] text-[#6E6E73] hover:text-[#1D1D1F] hover:bg-black/[0.06] border border-black/[0.04]'
                    }`}
                  >
                    {st.label}
                  </button>
            ...
            {isLoading ? (
              <div className="py-12 text-center text-xs text-[#86868B] flex flex-col items-center justify-center gap-2">
              ...
              <div className="overflow-x-auto rounded-2xl border border-black/[0.06]">
                <table className="w-full text-left text-xs font-sans">
                  <thead className="bg-[#F5F5F7] text-[#6E6E73] font-semibold text-[11px] border-b border-black/[0.06]">
                    <tr>
                        ...
                        <tr key={item.id} className="hover:bg-black/[0.02] transition-colors">
                          ...
                          <td className="py-3.5 px-3.5 max-w-xs">
                            <div className="flex items-center gap-1.5 mb-1">
                              <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-black/[0.04] text-[#1D1D1F] border border-black/[0.04]">
                                {item.type}
                              </span>
                            ...
                            <p className="text-[#6E6E73] line-clamp-2 leading-relaxed text-[11px]">
                              {item.notes}
                            </p>
                            {item.responseNote && (
                              <div className="mt-1.5 p-2 rounded-xl bg-emerald-50 border border-emerald-200/60 text-[10px] text-emerald-800">
                          ...
                          {/* Submitter & Date */}
                          <td className="py-3.5 px-3 text-[#6E6E73] whitespace-nowrap">
                            <div className="font-medium text-[#1D1D1F]">{item.submitter}</div>
                            ...
                            <button
                              ...
                              className={`inline-flex items-center gap-1 px-3 py-1 rounded-full border transition-all cursor-pointer ${
                                item.userVoted
                                  ...
                                  : 'bg-[#F5F5F7] border-black/[0.06] text-[#6E6E73] hover:text-[#1D1D1F] hover:bg-black/[0.06]'
                              }`}
                              title="为该收录心愿点赞催更"
                            >
                              <ThumbsUp
                              ...
                              />
                              <span className="font-mono text-xs tabular-nums">{item.votes}</span>
                            </button>
                          </td>
                        </tr>
                      );
                ...
                {filteredList.length === 0 && (
                  <div className="text-center py-10 text-[#86868B] font-sans">
                    暂无匹配的心愿单记录
                  </div>
                )}
              </div>
